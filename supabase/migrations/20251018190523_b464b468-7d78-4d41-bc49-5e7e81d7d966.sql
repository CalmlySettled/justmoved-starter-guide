-- Fix ambiguous cache_key reference in populate_cache_from_curation function
...
BEGIN
  ...
  LOOP
    ...
    -- Insert into recommendations cache using explicit constraint name to avoid ambiguity
