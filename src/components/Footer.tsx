    ...
    <footer className="bg-foreground text-background py-16">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="text-2xl font-bold">JustMoved</span>
            </div>
            <p className="text-background/80 leading-relaxed max-w-md">
              Making your move stress-free with personalized recommendations and local insights. 
              Join thousands who've found their perfect new home with JustMoved.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-background/80">
              <li className="flex items-center space-x-2">
                ...
                <span>hello@justmoved.com</span>
              </li>
              <li className="flex items-center space-x-2">
                <Phone className="h-4 w-4" />
                <span>1-800-JUSTMOVED</span>
              </li>
              <li className="flex items-center space-x-2">
        ...
        <div className="border-t border-background/20 pt-8 text-center text-background/60">
          <p>&copy; 2024 JustMoved. All rights reserved. Making moves memorable since 2024.</p>
        </div>
      </div>
    </footer>
  );
